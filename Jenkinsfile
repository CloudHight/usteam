...
//                 file: 'target/spring-petclinic-2.4.2.war',
        ...
        // stage('Trivy report slack notification') {
        //     steps {
        //         slackSend channel: '$SLACK_CHANNEL', message: 'Image Security Scan report generated by Olalere and waiting for review before approval ', teamDomain: 'Cloudhight', tokenCredentialId: 'slack-cred'
        //     }
        // }
        // stage('Security cleared Approval (trivy)') {
        //     steps {
